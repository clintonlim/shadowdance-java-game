...
public class HoldNote {
    ...
    public int checkScore(Input input, Accuracy accuracy, int targetHeight, Keys relevantKey) {
        if (isActive() && !holdStarted) {
            int score = accuracy.evaluateScore(getBottomHeight(), targetHeight, input.wasPressed(relevantKey), null) * SpecialNote.scoreMultiplier;
            ...
            int score = accuracy.evaluateScore(getTopHeight(), targetHeight, input.wasReleased(relevantKey), null) * SpecialNote.scoreMultiplier;
            ...
            if (score != Accuracy.NOT_SCORED) {
                ...
                deactivate();
                accuracy.setAccuracy(Accuracy.MISS, null);
